...
namespace Ltwhqt.ViewModels.Admin
{
    ...
    public class BranchViewModel
    {
        ...
        public string Manager { get; set; } // Tên hiển thị
    ...
    public class BranchFormViewModel
    {
        ...
        // Danh sách xổ xuống
        public IEnumerable<SelectOptionViewModel> WarehouseOptions { get; set; }
        public IEnumerable<SelectOptionViewModel> ManagerOptions { get; set; }
    }
